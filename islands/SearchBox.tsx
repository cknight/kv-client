      ...
      <div class="flex">
        <div class="w-2/3">
          <div class="w-full flex items-center">
            ...
            <KvKeyInput id="prefix" form="pageForm" type="text" name="prefix" class="rounded bg-blue-100 w-full p-2" value={prefix}/>
          </div>
          <div class="w-full flex items-center">
            <label for="start" class="w-24">Start</label>
            <KvKeyInput id="start" form="pageForm" type="text" name="start" class="rounded bg-blue-100 w-full p-2" value={start}/>
          </div>
          <div class="w-full flex items-center">
            <label for="end" class="w-24">End</label>
            <KvKeyInput id="end" form="pageForm" type="text" name="end" class="rounded bg-blue-100 w-full p-2" value={end}/>
          </div>
        </div>
        <div class="w-1/3 pb-1">
          <div class="flex items-center justify-end mr-[13px]">
            <label for="limit" class="w-24">Limit</label>
            <select id="limit" form="pageForm" name="limit" class="rounded bg-blue-100 w-24 p-2 my-2">
          ...
          <div class="w-full flex items-center justify-end mt-5">
            ...
            <input id="reverse" form="pageForm" type="checkbox" name="reverse" class="mr-12 w-4 h-4" checked={reverse}/>
          </div>
        </div>
      </div>

      <div class="flex w-full justify-center mt-4">
        <button type="submit" form="pageForm" class="px-2 py-1 rounded mx-4 bg-[#ff6b6b]">Reset</button>
        <button type="submit" form="pageForm" class="px-2 py-1 rounded mx-4 bg-[#6b6bff]">Search</button>
        <button type="submit" form="pageForm" class="px-2 py-1 rounded mx-4 bg-[#6b6bff]">Delete</button>
      </div>
